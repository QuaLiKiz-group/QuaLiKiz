  ...
  ELSE IF(QL_method.EQ.1) THEN
    ...
    DO ion=1,nions
        ...
        IF (phys_meth .NE. 0.0) THEN
           ...
           !rfonctpgti(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkgtirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFkgtirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpgni(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkgnirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFkgnirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpgui(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkguirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFkguirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpci(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkcirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFkcirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
...
!!!
           IF (phys_meth == 2) THEN
              ...
              !rfonctepgti(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekgtirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFekgtirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepgni(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekgnirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFekgnirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepgui(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekguirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFekguirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepci(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekcirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFekcirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
        ...
        !rfonctepi(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekirot,lw,ifailloc)
        !IF (ifailloc /= 0) THEN
        !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFekirot integration at p=',p,', nu=',nu,', ion=',ion
        !ENDIF
        ...
        !rfonctvpi(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFvkirot,lw,ifailloc)
        !IF (ifailloc /= 0) THEN
        !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of hcubature QL rFFvkirot integration at p=',p,', nu=',nu,', ion=',ion
        !ENDIF
  ...
  ELSE IF(QL_method.EQ.2) THEN
    ...
    DO ion=1,nions
        ...
        IF (phys_meth .NE. 0.0) THEN
           ...
           !rfonctpgti(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkgtirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFkgtirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpgni(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkgnirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFkgnirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpgui(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkguirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFkguirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
           ...
           !rfonctpci(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFkcirot,lw,ifailloc)
           !IF (ifailloc /= 0) THEN
           !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFkcirot integration at p=',p,', nu=',nu,', ion=',ion
           !ENDIF
...
!!!
           IF (phys_meth == 2) THEN
              ...
              !rfonctepgti(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekgtirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFekgtirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepgni(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekgnirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFekgnirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepgui(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekguirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFekguirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
              ...
              !rfonctepci(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekcirot,lw,ifailloc)
              !IF (ifailloc /= 0) THEN
              !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFekcirot integration at p=',p,', nu=',nu,', ion=',ion
              !ENDIF
        ...
        !rfonctepi(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFekirot,lw,ifailloc)
        !IF (ifailloc /= 0) THEN
        !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFekirot integration at p=',p,', nu=',nu,', ion=',ion
        !ENDIF
        ...
        !rfonctvpi(ion) = d01ahf(cc,dd,relaccQL1,npts,relerr,rFFvkirot,lw,ifailloc)
        !IF (ifailloc /= 0) THEN
        !   IF (verbose .EQV. .TRUE.) WRITE(stderr,"(A,I3,A,I3,A,I3,A,I3)") 'ifailloc = ',ifailloc,'. Abnormal termination of pcubature QL rFFvkirot integration at p=',p,', nu=',nu,', ion=',ion
        !ENDIF
